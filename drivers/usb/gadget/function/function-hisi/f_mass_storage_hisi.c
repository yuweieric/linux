 ...
 * =====================================================================================
 *
 *   Filename:  mass_storage_hisi.c
 *
 *   Description:  mass_storage support for mac system and configfs
 *
 *   Version:  1.0
 *   Created:  20160224
 *   Revision:  none
		...
		struct device_attribute *attr, const char *buf, size_t size)
{
	...
	if (size >= sizeof(opts->common->inquiry_string))
		return -EINVAL;
	if (sscanf(buf, "%s", opts->common->inquiry_string) != 1) /* [false alarm]:this is original code */
		return -EINVAL;
	return size;
}
