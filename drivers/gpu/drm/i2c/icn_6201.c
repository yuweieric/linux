...
static void icn6201_wirte_cmds(struct i2c_client *client, struct icn6201_cmd *table, unsigned int count)
{
	unsigned int i;
   for(i = 0; i < count; i++) 
	{	
			   ...
			   const struct i2c_device_id *id)
{
	...
	mdelay(500);	
	icn6201_wirte_cmds(client, icm6201_init_cmds, sizeof(icm6201_init_cmds) / sizeof(struct icn6201_cmd));
