...
int VENC_HAL_ResetReg()
{
#if 0// del by xwx495457
...
void VeduHal_CfgReg_SlcHeadSet(VENC_REG_INFO_S *channelcfg)
{
    ...
    //if (pEncPara_channel->vcpi_protocol== VEDU_H265) //add by m00218451
...
void VeduHal_CfgReg_SMMUSet(VENC_REG_INFO_S *channelcfg)
{
    ...
    {   //sec
        {
            ...
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[0].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[1].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[2].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[3].u32 = D32.u32;
        }

        {
            ...
            D32.bits.upwin = 1;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[4].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 3;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[5].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[6].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[7].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 72;
            D32.bits.len = 8;
            pAllReg->SMMU_MSTR_SMRX_0[8].u32 = D32.u32;
        }

        {
            ...
            D32.bits.upwin = 36;
            D32.bits.len = 4;
            pAllReg->SMMU_MSTR_SMRX_0[9].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[10].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[11].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 48;
            D32.bits.len = 8;
            pAllReg->SMMU_MSTR_SMRX_0[12].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 8;
            D32.bits.len = 2;
            pAllReg->SMMU_MSTR_SMRX_0[13].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 8;
            D32.bits.len = 2;
            pAllReg->SMMU_MSTR_SMRX_0[14].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[30].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 1;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[31].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 1;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[32].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[33].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[34].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 18;
            D32.bits.len = 8;
            pAllReg->SMMU_MSTR_SMRX_0[35].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 9;
            D32.bits.len = 4;
            pAllReg->SMMU_MSTR_SMRX_0[36].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[37].u32 = D32.u32;
        }
        {
            U_SMMU_MSTR_SMRX_0  D32;
            D32.bits.bypass = 0;
            D32.bits.upwin = 0;
            D32.bits.len = 1;
            pAllReg->SMMU_MSTR_SMRX_0[38].u32 = D32.u32;
        }
    }
    else
    {//nosec
    ...
    {   //sec
        for (i = 0; i < 15; i++)
        {
            pAllReg->SMMU_MSTR_SMRX_0[i].u32 = channelcfg->all_reg.SMMU_MSTR_SMRX_0[i].u32;
        }
        for (i = 30; i < 39; i++)
        {
            pAllReg->SMMU_MSTR_SMRX_0[i].u32 = channelcfg->all_reg.SMMU_MSTR_SMRX_0[i].u32;
...
void VeduHal_CfgReg(VENC_REG_INFO_S *channelcfg)
{
    S_HEVC_AVC_REGS_TYPE *pAllReg = NULL;
    unsigned int vcpi_protocol = 0;
...
*/
    ...
    {
        //U_VEDU_VCPI_START  D32;
        //D32.bits.vcpi_vstart = 0;//channelcfg->all_reg.VEDU_VCPI_START.vcpi_vstart;
        //D32.bits.vcpi_vstep = channelcfg->all_reg.VEDU_VCPI_START.vcpi_vstep;
        //pAllReg->VEDU_VCPI_START.u32 = channelcfg->all_reg.VEDU_VCPI_START.u32;
    }
    {
